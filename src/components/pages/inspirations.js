...
const Inspiration = () => (
    ...
    <h2 className='pageHeadings'>Inspirational Stories</h2>
    ...
    <main>
        <ul className='acc-list'>
             ...
             <li className='acc-item'>
                ...
                <h3 className='acc-h3'>The 'locality' initiative in Tollington<span className='acc-list-span'>&#9650;
                </span></h3>
                </label>
                <p className='acc-list-content'>
