    ...
    <div>
        ...
        <main>
            <ul>
                ...
                <span className='li-content'>You can read the Brickworks Social Action Hub privacy policy</span><a href='https://hanleycrouch.files.wordpress.com/2018/06/privacy-policy-hcca.pdf'> here</a>.</li>
            </ul>
        </main>
        </div>
    </div>
