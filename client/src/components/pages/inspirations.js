    ...
    <main>
        <ul className='acc-list'>
             ...
             <li className='acc-item'>
                ...
                <br></br>
                <br></br>
                The first phase of 'Locality' has focused on Insights and Data Gathering, which have revealed some interesting facts and statistics. These, combined with the engagement of local organisations, businesses and residents, have helped identify some key areas of concern linked to poverty, isolation and health and well-being. These are now the main focus for collective social action, with Brickworks being developed, supported and promoted as the heart of the community.
                </p>
             </li>
        </ul>
    </main>
